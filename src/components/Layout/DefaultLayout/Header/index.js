...
function Header() {
    ...
    return ( <div className={cx('wrapper')}>
        ...
        <div className={cx('warpper-link')}>
            ...
            <div className={cx('warpper-link-h')}>
                <Link className={cx('link')} to='/'> Tour Trong Nước <span><FontAwesomeIcon icon={faCaretDown} /></span> </Link>
                <Link className={cx('link')} to='/'>Tour Nước Ngoài <span><FontAwesomeIcon icon={faCaretDown} /></span></Link>
