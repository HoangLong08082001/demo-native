...
export default function Booking({callBackname,Giam,Price,MaTour}) {
  ...
  useEffect(()=>{
    callBackname(name,email,sdt,diachi,countprice,Person,Personmin,Personbe)
  ...
  return (
    <div className={cx("booking")}>
        <div className={cx("booking-information")}>
            <div>
                 <span>Họ Tên</span>
                 <input className={cx("booking-information-input")} value={name} onChange={(e)=>setname(e.target.value)}  type="text" id="fname" name="firstname" placeholder="Your name.."></input>
            </div>
            <div>
                 <span>Email</span>
                 <input className={cx("booking-information-input")} value={email} onChange={(e)=>setemail(e.target.value)}  type="email" id="fname" name="firstname" placeholder="Your email.."></input>
            </div>
            <div>
                 <span>Số Điện Thoại</span>
                 <input className={cx("booking-information-input")} value={sdt} onChange={(e)=>setsdt(e.target.value)} type="number" id="fname" name="firstname" placeholder="Your phone.."></input>
            </div>
            <div>
                 <span>Địa Chỉ</span>
                 <input className={cx("booking-information-input")} value={diachi} onChange={(e)=>setdiachi(e.target.value)} type="text" id="fname" name="firstname" placeholder="Your address.."></input>
            </div>
        </div>
        <div className={cx("booking-total")}>
           ...
           <div className={cx("booking-total-check")}><span>Em Bé </span> 
           <span> </span>
           <span style={{color:"#d10a00", fontWeight:600}}></span>
           <button onClick={handledownbe}>-</button>
           <span>{Personbe}</span>
           <button onClick={handleupbe}>+</button></div>
           <div className={cx("booking-total-title")}><span>Chính Sách Giá </span></div>
            <div className={cx("booking-total-check")}>
           ...
           <div className={cx("booking-total-price")}><span>Tổng Cộng</span> <span>{a} </span></div>
