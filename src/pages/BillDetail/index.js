...
function BillDetail() {
  ...
  return (
    <div>
      <Button login onClick={hanldepre}>
        Trang Chủ
      </Button>
        ...
        <div className={cx("box")}>
          <div className={cx("box-head")}>
            ...
            <div>
              ...
              <h5>
                Địa Chỉ : 180 Cao Lỗ, Quận 8, Thành Phố Hồ Chí Minh{" "}
                <span style={{ marginLeft: "20px" }}>
                  SĐT : 342352523523 Fax : 32627262
                </span>{" "}
              </h5>
            </div>
          </div>
          <div className={cx("box-head-detail")}>
            ...
            <div>
              <p>
                Cảm ơn quý khách hàng đã sử dụng dịch vụ của công ty chúng tôi.
                Mong quý khách sẽ có một chuyến đi hạnh phúc và vui vẻ bên gia
                đình và bạn bè. Nếu quý khách hàng có ý kiến hoặc phản hồi trong
                suốt quá trình của chuyến đi xin hãy liên hệ số hotline tổng đài
                để được tư vấn.{" "}
              </p>
            </div>
          </div>
          <div className={cx("box-accept")}>
            ...
            <div>
              ...
              <div className={cx("box-input")}>
                <p>Số Khách</p>
                <p>
                  {parseInt(value.NguoiLon + value.TreEm + value.EmBe)}(Người
                  lớn:{value.NguoiLon} Trẻ em: {value.TreEm} Em bé: {value.EmBe}{" "}
                  )
                </p>
              </div>
            </div>
          ...
          <div className={cx("box-head-detail")}>
            ...
            <div>
              <p>
                Mọi thông tin cá nhân của khách hàng sẽ được bảo mật an toàn.{" "}
              </p>
            </div>
          </div>
        </div>
